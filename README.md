...
```bash
npm install github:volcanica/react-auth-library
# or
pnpm add github:volcanica/react-auth-library
# or
yarn add github:volcanica/react-auth-library
```
...
### Server (`@volcanica/firebase-auth-nextjs/server`)
...
### Client (`@volcanica/firebase-auth-nextjs/client`)
...
### Next.js App Router (`@volcanica/firebase-auth-nextjs/next/app-router`)
...
### Middleware (`@volcanica/firebase-auth-nextjs/next/middleware`)
